...
public:
	 ...
	 *           this function and the client walks on it, there occurs a bug that
	 *           prevents normal movement with a warning "LogNetPackageMap:
	 *           Warning: UPackageMapClient::InternalLoadObject: Unable to resolve
